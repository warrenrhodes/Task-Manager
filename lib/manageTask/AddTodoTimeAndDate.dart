...
class _AddTodoTimeAndDateDialogueWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      backgroundColor: Get.isDarkMode ? HexColor("#242028") : Colors.white,
                  ...
                  children: [
                    Expanded(
                      child: CalendarCarousel(
                        ...
                        width: Get.width + 20,
                        weekdayTextStyle: Get.isDarkMode
                            ? TextStyle(color: Colors.white60)
                            : TextStyle(color: Colors.black),
                        iconColor: Get.isDarkMode ? Colors.blue : Colors.blue,
                          ...
                          TextButton(
                            ...
                            onPressed: () {
                              var y = _listWeek
                                  ...
                                  .toList();
                              if (y.length == 0) {
                                _validWeek.add(_listWeek
                                    .where((element) => element._week.keys
                                        .where((element) =>
                                            TaskForm.week(element) ==
  ...
  List<Widget> _weekday() {
    ...
    //     .where((element) => element._week.keys
    //         .where(
    //             (element) => TaskForm.week(element) == DateTime.now().weekday)
    //         .isNotEmpty)
    //     .first
    //     .isSelected = true;
    List<Widget> chips = [];
